...
são altamente poluentes do meio ambiente. O índice de poluição aceitável varia de 0,05 até 0,25. Se o índice sobe 
...
devem ser notificados a paralisarem suas atividades. Faça um sistema que leia o índice de poluição medido e emita 
...
programa
{
	...
	senao se (indice>=0.4 e indice<0.5){
		escreva("Indústrias do 1º e 2º grupo devem suspender suas atividades.")
	}
	senao se (indice>=0.5) {

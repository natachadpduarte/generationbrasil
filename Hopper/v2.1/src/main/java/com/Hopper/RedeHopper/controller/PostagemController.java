...
public class PostagemController {
	...
	@PostMapping
	public ResponseEntity<PostagemEntidade> post(@Valid @RequestBody PostagemEntidade postagementidade) {
		return ResponseEntity.status(HttpStatus.CREATED).body(repository.save(postagementidade));
	}

	@PutMapping
	public ResponseEntity<PostagemEntidade> put(@Valid @RequestBody PostagemEntidade postagementidade) {
